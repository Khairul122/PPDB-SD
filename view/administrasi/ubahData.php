                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="peserta" required="">
                                            ...
                                            foreach ($data as $r) {
                                            ?>
                                                <option value="<?= $r['Id_Identitas_Siswa']; ?>" <?php if ($row['id_identitas_siswa'] == $r['Id_Identitas_Siswa']) {
                                                                                                        echo 'selected';
                                                                                                    } ?>><?= $r['NISN'] . " | " . $r['Nama_Peserta_Didik']; ?></option>
                                            <?php } ?>
                                            <!-- Semua -->
                                            <?php
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select class="form-control" name="status" required="">
                                            ...
                                            <option value="Lolos" <?php if ($row['status'] == 'Lolos') {
                                                                        echo 'selected';
                                                                    } ?>>Lolos</option>
                                            <option value="Tidak Lolos" <?php if ($row['status'] == 'Tidak Lolos') {
                                                                            echo 'selected';
                                                                        } ?>>Tidak Lolos</option>
                                        </select>
                                        <!-- Validation -->
