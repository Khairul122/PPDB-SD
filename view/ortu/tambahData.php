							...
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<select class="form-control" name="peserta" required="">
										...
										foreach ($data as $r) {
											$selected = (isset($row) && isset($row['id_identitas']) && $row['id_identitas'] == $r['Id_Identitas_Siswa']) ? 'selected' : '';
										?>
											<option value="<?= $r['Id_Identitas_Siswa']; ?>" <?= $selected; ?>>
												<?= $r['NISN'] . " | " . $r['Nama_Peserta_Didik']; ?>
											</option>
										<?php } ?>
									</select>
								</div>
